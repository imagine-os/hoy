...
- Version: **0.6.1** (2026-09-17) — v0.6.0's public website rebuilt around the brand content (W-01…W-08, P-01), the five thin screens deepened (M-02a…M-02d content CMS, M-09a/M-09b teacher payouts, S-03 payroll, A-06 as a versioned legal library, photo and map slots on one `media_assets` contract), and the operations manual rebuilt as 28 bilingual chapters in seven parts with 64 figures and live data blocks; plus, in 0.6.1, the expenses ledger (M-09c and the Balance card on M-09); 44 tables with per-table access intent; **90 routes, 78 page codes, 0 stubs** (`/#/dev/specs`), 373 screenshots, 55 components in D-02. Changelog: [`docs/changelog/`](./docs/changelog/) · what is still mocked and what is left: [`ROADMAP.md` §F](./ROADMAP.md).
