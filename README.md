...
| Staff by role | `/#/staff`, `/#/admin` | Front desk, coordinator, admin, finance, super admin, maintenance (desktop-first): role home, check-in, register & pay, dashboard, tables, CMS, emails, WhatsApp, CRM, activity, settings (general, features, payments, communications, branding), finance and teacher payouts, account-deletion queue | built (S-01, S-02, S-04, S-05, M-01…M-09, M-11, M-02a…M-02d, M-08a…M-08e, M-09a…M-09c) |
