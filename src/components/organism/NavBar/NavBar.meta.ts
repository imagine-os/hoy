...
export default defineMeta({
  ...
  usages: [{ title: { es: 'Cliente', en: 'Customer' }, render: () => (h('div', { style: { maxWidth: 390, border: '1px solid var(--color-border)', borderRadius: 16, overflow: 'hidden' } }, h(NavBar, { items: [{ to: '/app', label: 'Inicio', icon: '⌂', end: true }, { to: '/app/schedule', label: 'Horario', icon: '▦' }, { to: '/app/plans', label: 'Planes', icon: '◇' }, { to: '/app/more', label: 'Más', icon: '⋯' }] }))) }],
