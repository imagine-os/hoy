...
export default defineMeta({
  ...
  usages: [{ title: { es: 'Dos variantes', en: 'Two variants' }, render: () => (h('div', { className: 'stack-sm' }, h(TopBar, { brand: true, sticky: false, actions: h('div', { className: 'row' }, h(LangToggle, { size: 'sm' }), h(Avatar, { name: 'Juliana Ospina', size: 28 })) }), h(TopBar, { title: 'Horario', back: '/app', sticky: false }))) }],
