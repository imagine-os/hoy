    ...
    <AuthShell>
      <div className="auth-col">
        <Card padding="lg" className="stack cust-center">
          ...
          <a href={waLink(tenant.contact.whatsapp, t('customer.locked.whatsappText'))} target="_blank" rel="noreferrer" style={{ width: '100%' }}><Button block variant="secondary">{t('customer.locked.whatsapp')}</Button></a>
