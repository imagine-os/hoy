...
export const contentArticles: ContentArticleRow[] = [
  { ...base('art_hot_room', 120), slug: 'hot-room', section: 'rules', icon: '♨', required: false, sort: 1, published: true,
  ...
  { ...base('art_preparation', 120), slug: 'preparation', section: 'rules', icon: '◔', required: false, sort: 2, published: true,
  ...
  { ...base('art_etiquette', 120), slug: 'etiquette', section: 'rules', icon: '☼', required: false, sort: 3, published: true,
  ...
  { ...base('art_tour', 120), slug: 'tour', section: 'rules', icon: '▶', required: false, sort: 4, published: true,
  ...
  { ...base('art_emergencies', 120), slug: 'emergencies', section: 'rules', icon: '✚', required: true, sort: 5, published: true,
    ...
    checklist: null, video_label: null },
  { ...base('art_about', 120), slug: 'about', section: 'about', icon: '◎', required: false, sort: 6, published: true,
