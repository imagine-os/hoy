...
export const teachers: TeacherRow[] = [
  { ...base('tea_andres', 180), user_id: 'usr_teach', display_name: 'Andrés Quintero', bio: { es: 'Hot Vinyasa con humor y disciplina. 8 años enseñando.', en: 'Hot Vinyasa with humour and discipline. 8 years teaching.' }, photo_url: null, specialties: ['mod_hot_vinyasa', 'mod_morning_flow'], rate_per_class: 90000, active: true, rating_avg: 4.8 },
  { ...base('tea_paula', 180), user_id: null, display_name: 'Paula Mejía', bio: { es: 'Pilates clásico y contemporáneo. Precisión amable.', en: 'Classical and contemporary Pilates. Kind precision.' }, photo_url: null, specialties: ['mod_pilates', 'mod_barre'], rate_per_class: 85000, active: true, rating_avg: 4.9 },
  { ...base('tea_santiago', 180), user_id: null, display_name: 'Santiago Vélez', bio: { es: 'Yin y meditación. Menos es más.', en: 'Yin and meditation. Less is more.' }, photo_url: null, specialties: ['mod_yin', 'mod_meditacion'], rate_per_class: 80000, active: true, rating_avg: 4.7 },
  { ...base('tea_manuela', 180), user_id: null, display_name: 'Manuela Torres', bio: { es: 'Morning Flow con música y respiración.', en: 'Morning Flow with music and breath.' }, photo_url: null, specialties: ['mod_morning_flow', 'mod_yin'], rate_per_class: 85000, active: true, rating_avg: 4.6 },
  { ...base('tea_daniel', 180), user_id: null, display_name: 'Daniel Ochoa', bio: { es: 'Barre y fuerza funcional.', en: 'Barre and functional strength.' }, photo_url: null, specialties: ['mod_barre', 'mod_pilates'], rate_per_class: 80000, active: true, rating_avg: 4.5 },
  { ...base('tea_isabela', 180), user_id: null, display_name: 'Isabela Cano', bio: { es: 'Hot Vinyasa exigente y clara.', en: 'Demanding, clear Hot Vinyasa.' }, photo_url: null, specialties: ['mod_hot_vinyasa'], rate_per_class: 90000, active: true, rating_avg: 4.9 },
  { ...base('tea_felipe', 180), user_id: null, display_name: 'Felipe Zapata', bio: { es: 'Meditación y pranayama para gente ocupada.', en: 'Meditation and pranayama for busy people.' }, photo_url: null, specialties: ['mod_meditacion'], rate_per_class: 75000, active: true, rating_avg: 4.7 },
  { ...base('tea_carolina', 180), user_id: null, display_name: 'Carolina Pardo', bio: { es: 'Pilates mat y rehabilitación suave.', en: 'Mat Pilates and gentle rehab.' }, photo_url: null, specialties: ['mod_pilates'], rate_per_class: 85000, active: true, rating_avg: 4.8 },
];
