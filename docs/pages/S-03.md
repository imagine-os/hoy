...
## Changelog
- `docs/changelog/0019-app-store-readiness.md` — the KPI tiles no longer wrap their value (StatTile fit + phone-frame container query); `es-390-payroll.jpg` / `en-1280-payroll.jpg` are the payroll statement as the teacher (v0.7.0)
